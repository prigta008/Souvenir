...
import { GET_COMMENT_FAIL, GET_COMMENT_REQUEST, GET_COMMENT_SUCCESS, POST_COMMENT_FAIL, POST_COMMENT_REQUEST, POST_COMMENT_SUCCESS, URL } from "./constants";
...
export const postComment = (author, user_id, post_id, content) => async (dispatch) => {
    ...
    try {
        ...
        Swal.fire({icon:"success",html:"Added Successfully"})
    } catch (error) {
        dispatch({
